...
export const PERMISSION_DEFS: { key: string; labelAr: string; labelEn: string; group: string }[] = [
  ...
  { key: "schedule.view_all",      labelAr: "عرض جداول كل الوكلاء",            labelEn: "View all schedules",              group: "schedule" },
  ...
  { key: "attendance.record",      labelAr: "تسجيل حضور الوكلاء",              labelEn: "Record agent attendance",         group: "attendance" },
  { key: "attendance.view_all",    labelAr: "عرض حضور كل الوكلاء",             labelEn: "View all attendance",             group: "attendance" },
  { key: "attendance.view_team",   labelAr: "عرض حضور فريقه",                 labelEn: "View team attendance",            group: "attendance" },
  { key: "attendance.view_own",    labelAr: "عرض حضوره الخاص",                labelEn: "View own attendance",             group: "attendance" },
...
export const DEFAULT_GRANTS: Record<Role, string[]> = {
  ...
  wfm: [
    ...
    "schedule.manage", "schedule.view_all", "schedule.import", "schedule.policy_edit", "schedule.auto_breaks", "schedule.swap_approve",
    "attendance.view_all",
    "attendance.view_all",
    "notifications.view_own",
  ],
